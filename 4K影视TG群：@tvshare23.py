...
class Spider(Spider):
    ...
    def init(self, extend=""):
        ...
        self.custom_card = {
            ...
            "vod_name": "📢 官方交流群",
            "vod_pic": "https://img.naixiai.cn/2026/08/10/2026-08-10_22-42-38.png",
            "vod_remarks": "关注群组"
        }
    ...
    def _insert_custom_card(self, video_list, target_index=2):
        ...
        if not isinstance(video_list, list):
            video_list = []
        # 即使抓不到视频，也至少显示公告图片，防止页面全空
        if not video_list:
            return [self.custom_card]
    ...
    def homeContent(self, filter):
        ...
        # 尝试安全获取 filter，失败则留空，绝对不让整体抛错
        try:
            filters_data = self._get_all_filters()
        except Exception:
            filters_data = {}
    ...
    def detailContent(self, ids):
        ...
        if vod_id == self.custom_card["vod_id"]:
            return {
                "list": [{
                    "vod_id": vod_id,
                    "vod_name": self.custom_card["vod_name"],
                    "vod_pic": self.custom_card["vod_pic"],
                    "vod_content": "欢迎加入 Telegram 官方交流群：@tvshare23！获取最新接口与软件更新通知。",
                    "vod_actor": "@tvshare23",
                    "vod_director": "管理员",
                    "vod_area": "官方",
                    "vod_year": "2026",
                    "vod_play_from": "官方频道",
                    "vod_play_url": "访问 Telegram 交流群$https://t.me/tvshare23"
                }]
            }
